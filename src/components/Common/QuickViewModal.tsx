...
const QuickViewModal = () => {
  ...
  return (
    <div
      ...
      } fixed top-0 left-0 overflow-y-auto no-scrollbar w-full h-screen sm:py-20 xl:py-25 2xl:py-[230px] bg-[#116735]/70 sm:px-8 px-4 py-5`}
    >
          ...
          <div className="flex flex-wrap items-center gap-12.5">
              ...
              <div className="flex gap-5">
                ...
                <div className="relative z-1 overflow-hidden flex items-center justify-center w-full sm:min-h-[508px] bg-gray-1 rounded-lg border border-gray-3">
                  <div>
                    ...
                    <Image
                      src={product?.imgs?.previews?.[activePreview] || "/images/products/product-1-bg-1.png"}
            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <button
                  className={`inline-flex items-center gap-2 font-medium text-white bg-[#116735] py-3 px-6 rounded-md ease-out duration-200 hover:bg-opacity-95 `}
                >
                  <svg
                    className="fill-current"
                    width="20"

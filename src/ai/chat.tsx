...
import { IAIChat } from "@/ai/ai-chat";

export default function CustomChat({onClose}: IAIChat) {
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        //className="whitespace-pre-wrap font-mono anti text-sm text-neutral-800 dark:text-neutral-200 overflow-hidden max-h-72 overflow-y-scroll no-scrollbar-gutter"
        id="markdown"
      >
...
const MemoizedReactMarkdown: React.FC<MarkdownProps> = React.memo(
  ReactMarkdown,
